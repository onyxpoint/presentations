...
TITLE = 'Techniques for Deploying and Managing Software'
DESCRIPTION = 'A presentation and demos regarding the deployment and management of system software'
AUTHOR = 'Trevor Vaughan - Onyx Point, Inc.'
GLOBAL_HEADER = 'Techniques for Deploying and Managing Software'
