...
TITLE = 'Introduction to the Puppet Ecosystem'
DESCRIPTION = 'A presentation describing the basics of Puppet and surrounding, supporting, technologies'
AUTHOR = 'Trevor Vaughan - Onyx Point, Inc.'
GLOBAL_HEADER = 'Introduction to the Puppet Ecosystem'
